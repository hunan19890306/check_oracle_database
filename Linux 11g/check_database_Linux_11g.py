...
#ssh连接到节点一取的信息
    ...
    #grid_base生成
    grid_base_stdin, grid_base_origin, grid_base_stderr = ssh_db1.exec_command("source /home/grid/.bash_profile;echo $ORACLE_BASE")
    grid_base = grid_base_origin.read().replace('\n','')
    #grid_home生成
    grid_home_stdin, grid_home_origin, grid_home_stderr = ssh_db1.exec_command("source /home/grid/.bash_profile;echo $ORACLE_HOME")
    ...
    #cluster变量生成
    cluster_stdin, cluster_origin, cluster_stderr = ssh_db1.exec_command("source /home/grid/.bash_profile;crsctl stat res -t")
    ...
    #ocr_backup变量生成
    ocr_backup_stdin, ocr_backup_origin, ocr_backup_stderr = ssh_db1.exec_command("source /home/grid/.bash_profile;ocrconfig -showbackup")
    ...
    #listener1变量生成
    listener1_stdin, listener1_origin, listener1_stderr = ssh_db1.exec_command("source /home/grid/.bash_profile;lsnrctl stat")
...
#ssh连接到节点二取的信息    
    ...
    #listener2变量生成
    listener2_stdin, listener2_origin, listener2_stderr = ssh_db2.exec_command("source /home/grid/.bash_profile;lsnrctl stat")
